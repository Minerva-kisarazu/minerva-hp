    ...
    <>
      ...
      <section className="bg-slate-50 text-gray-900 py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm mb-6 border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">小学生</h3>
          ...
          {/* 中学生 */}
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm mb-6 border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">中学生</h3>
            <p className="text-gray-700 leading-relaxed font-light">
          ...
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">高校生</h3>
            <p className="text-gray-700 leading-relaxed font-light">
      ...
      <section className="bg-navy-800 text-white py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="max-w-4xl mx-auto text-lg text-gray-300 mb-12 text-center leading-relaxed font-light">
          ...
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-xl mb-4 card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-4 text-accent tracking-wide">月曜日</h3>
          ...
          {/* 火曜日 */}
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-xl mb-4 card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-4 text-accent tracking-wide">火曜日</h3>
            <ul className="space-y-3 text-gray-200 leading-relaxed">
              <li className="flex items-start">
                <span className="text-accent mr-2 mt-1">・</span>
          ...
          {/* 水曜日 */}
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-xl mb-4 card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-4 text-accent tracking-wide">水曜日</h3>
            <ul className="space-y-3 text-gray-200 leading-relaxed">
              <li className="flex items-start">
                <span className="text-accent mr-2 mt-1">・</span>
          ...
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-xl card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-4 text-accent tracking-wide">木曜日</h3>
            <ul className="space-y-3 text-gray-200 leading-relaxed">
              <li className="flex items-start">
                <span className="text-accent mr-2 mt-1">・</span>
      ...
      <section className="bg-slate-50 text-gray-900 py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-10 text-center tracking-wide">
            授業を実力に変える「自習スペース」
          </h2>
          <p className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed font-light">
