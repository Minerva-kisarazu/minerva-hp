...
const gradePolicies = [
  {
    ...
    body: '答えが合えばいいという作業を繰り返すのではなく、「なぜそうなるか」を考える習慣を作ります。学校の国語や算数の学習を土台に、これからの学習につながる基本的な学び方を身につけます。',
    items: [
      'ノートの取り方',
      '問題文の読み方',
      '計算ミスの原因確認',
  ...
  {
    grade: '中学生',
    headline: '定期テストで目標点を取り、自分で演習する力を身につける',
    body: '学校の授業や定期テストの内容を確認し、今どこを優先して勉強するべきかを整理します。学校ワークの進め方やテスト前の学習方法まで含めて、自分で学習を進められる状態を目指します。',
    items: [
      '定期テスト対策',
      '学校ワークの進め方',
      '苦手単元の特定',
  ...
  },
  {
    ...
    body: '高校生は、すべてを同じように勉強するのではなく、現在の成績や目標から、何を優先するべきかを整理します。定期テスト対策から大学受験まで、限られた時間をどう使うかを一緒に設計します。',
    items: [
      '定期テスト対策',
      '大学受験に向けた学習計画',
      '科目ごとの優先順位',
...
const lessonExamples = [
  {
    ...
    challenge: 'まだ勉強の進め方が定まっていない段階',
    action:
      'ノートの取り方、問題の読み方、間違い直しなど、これから先の学習につながる基本を授業で身につけます。',
  },
  {
    grade: '中学生',
    ...
    action:
      '学校の進度やテスト範囲、理解度を確認し、授業と自習を組み合わせて必要な学習を進めます。',
  },
  {
    grade: '高校生',
    ...
    action:
      '現在の理解度と目標から今取り組むべき内容を明確にし、自分で学習を進められる状態をつくります。',
  },
];
