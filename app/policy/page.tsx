    ...
    <>
      ...
      <section className="bg-slate-50 text-gray-900 py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-serif font-bold mb-10 tracking-wide">
          ...
          <p className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed mt-8">
      ...
      <section className="bg-navy-800 text-white py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto bg-navy-900 p-10 rounded-lg mb-8 card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">対話が生む「思考の言語化」</h3>
          ...
          <div className="max-w-4xl mx-auto bg-navy-900 p-10 rounded-lg card-shadow-sm border border-slate-700">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">「自力で読み解く」練習の徹底</h3>
            <p className="text-gray-200 leading-relaxed font-light">
      ...
      <section className="bg-slate-50 text-gray-900 py-24 md:py-36">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm mb-8 border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">【解き方と手の動きの分析】</h3>
          ...
          {/* 詳細 2 */}
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm mb-8 border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">【思考停止が起きるポイントの分析】</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl card-shadow-sm border border-slate-100">
            <h3 className="text-xl font-serif font-bold mb-5 text-accent tracking-wide">【知識の境界線の分析】</h3>
            <p className="text-gray-700 leading-relaxed">
      ...
      <section className="bg-primary text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl md:text-2xl font-serif font-medium mb-8 tracking-wide opacity-90 leading-relaxed">
