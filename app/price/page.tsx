          ...
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mb-12">
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>18,700 円</li>
                <li><strong>2 講座：</strong>31,900 円</li>
                <li><strong>3 講座：</strong>44,000 円</li>
                <li><strong>4 講座：</strong>56,100 円</li>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>19,800 円</li>
                <li><strong>2 講座：</strong>34,100 円</li>
                <li><strong>3 講座：</strong>47,300 円</li>
                <li><strong>4 講座：</strong>60,500 円</li>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>20,900 円</li>
                <li><strong>2 講座：</strong>36,300 円</li>
                <li><strong>3 講座：</strong>50,600 円</li>
                <li><strong>4 講座：</strong>64,900 円</li>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>22,000 円</li>
                <li><strong>2 講座：</strong>38,500 円</li>
                <li><strong>3 講座：</strong>53,900 円</li>
                <li><strong>4 講座：</strong>69,300 円</li>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>23,100 円</li>
                <li><strong>2 講座：</strong>40,700 円</li>
                <li><strong>3 講座：</strong>57,200 円</li>
                <li><strong>4 講座：</strong>73,700 円</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                <li><strong>1 講座：</strong>24,200 円</li>
                <li><strong>2 講座：</strong>42,900 円</li>
                <li><strong>3 講座：</strong>60,500 円</li>
                <li><strong>4 講座：</strong>78,100 円</li>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-gray-700 leading-relaxed">
                <strong>入塾費：</strong>22,000 円（税込・初月のみ受講費と合わせて納入）<br />
