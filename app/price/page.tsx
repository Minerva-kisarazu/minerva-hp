...
const faqs = [
  {
    ...
    detail:
      '授業で分からないところを教えるだけではなく、問題を読む→考える→解く→確かめるという学習プロセスそのものを確認する点が大きな違いです。授業は差がつきやすい英数に特化しますが、自習管理を通じて「5教科すべて」をサポートしています。授業のない日も自習室で理科・社会・国語の進捗チェックと質問対応を行い、授業で2教科の土台を築き、自習室と進度管理で5教科の点数を引き上げます。',
  },
  {
