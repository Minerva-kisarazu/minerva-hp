...
const faqs = [
  {
    ...
    detail:
      '授業で分からないところを教えるだけではなく、問題を読む→考える→解く→確かめるという学習プロセスそのものを確認する点が大きな違いです。差がつきやすく自学が難しい英数を中心に授業を受けることが多いですが、全教科に対応しています。授業科目以外の質問も受け付け、必要に応じて宿題として出すこともできます。',
  },
  {
    question: '英数しかやっていないのですか？',
    summary: 'いいえ。全教科に対応しています。',
    detail:
      '中学生や高校生で理科を受講している生徒さんもいらっしゃいます。差がつきやすく、自学が難しい英数を中心に授業を受けていただくことが多いです。授業で受けている科目以外も質問していただいて構いませんし、場合によっては授業科目以外を宿題として毎週出していくことも可能です。',
  },
  {
  ...
  },
  {
    ...
    detail:
      '集団塾に比べれば月謝の額面は高くなります。しかしミネルバの料金には、毎回の学習動作・判断の癖の分析、保護者様への即日指導報告、追加料金なしで毎日使える自習スペースでの質問対応が含まれています。指導報告では、その日にできたこと・手が止まった箇所・その原因・次にやることを毎回書いています。1回80分の授業だけではなく、授業の外での学習まで含めて支える料金です。',
  },
  {
  ...
  },
  {
    ...
    detail:
      'テスト範囲に合わせて、提出必須の学校ワークの進行から、出題されやすい単元の確認まで対応します。',
  },
];
