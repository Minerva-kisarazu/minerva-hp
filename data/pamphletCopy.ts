...
export const pamphletWeekRows = [
  ...
  {
    day: '火曜日',
    slots: [{ time: '17:20〜19:30', body: '自習室利用（学校ワーク・理社の教科書演習）' }],
  },
  {
    day: '水曜日',
    slots: [
...
export const pamphletFaqs = [
  {
    q: '普通の個別指導塾と、何が違うんですか？',
    a: '授業で解けるようにするだけでなく、「自分で学べる状態」を作ることを重視しています。自習室での5教科の進度管理も含みます。',
  },
  {
    q: '個別指導だから、料金が高いのではありませんか？',
    a: '授業だけでなく、自習室での5教科管理・質問対応・毎回の指導報告まで含めた料金です。',
  },
  {
  ...
  {
    q: '自習室は、授業がない日も利用できますか？',
    a: 'はい。1講座でも、開校時間内は毎日無料でご利用いただけます。',
  },
] as const;
