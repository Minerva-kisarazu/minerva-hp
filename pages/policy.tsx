    ...
    <>
      ...
      <section className="bg-gray-50 text-gray-900 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed mt-6">
      ...
      <section className="bg-navy-800 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 項目 1 */}
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-lg mb-8">
            <h3 className="text-xl font-bold mb-4 text-gold-500">対話が生む「思考の言語化」</h3>
          ...
          <div className="max-w-4xl mx-auto bg-navy-900 p-8 rounded-lg">
            <h3 className="text-xl font-bold mb-4 text-gold-500">「自力で読み解く」練習の徹底</h3>
            <p className="text-gray-300 leading-relaxed">
      ...
      <section className="bg-gray-50 text-gray-900 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mb-8">
            <h3 className="text-xl font-bold mb-4 text-gold-500">【解き方と手の動きの分析】</h3>
          ...
          {/* 詳細 2 */}
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mb-8">
            <h3 className="text-xl font-bold mb-4 text-gold-500">【思考停止が起きるポイントの分析】</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-4 text-gold-500">【知識の境界線の分析】</h3>
            <p className="text-gray-700 leading-relaxed">
